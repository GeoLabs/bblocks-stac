...
```jsonld
{
  "@context": "https://raw.githubusercontent.com/GeoLabs/bblocks-stac/undefined/build/annotated/contrib/stac/extensions/accuracy/context.jsonld",
  "stac_version": "1.0.0",
  "stac_extensions": [
    "https://stac-extensions.github.io/accuracy/v1.0.0-beta.1/schema.json"
  ],
...
x-jsonld-extra-terms:
  accuracy:geometric_x_bias:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/geometric_x_bias
    x-jsonld-type: xsd:double
  accuracy:geometric_y_bias:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/geometric_y_bias
    x-jsonld-type: xsd:double
  accuracy:geometric_x_stddev:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/geometric_x_stddev
    x-jsonld-type: xsd:double
  accuracy:geometric_y_stddev:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/geometric_y_stddev
    x-jsonld-type: xsd:double
  accuracy:geometric_rmse:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/geometric_rmse
    x-jsonld-type: xsd:double
  accuracy:measurement_relative:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/measurement_relative
    x-jsonld-type: xsd:double
  accuracy:measurement_absolute:
    x-jsonld-id: https://w3id.org/ogc/stac/accuracy/measurement_absolute
    x-jsonld-type: xsd:double
x-jsonld-prefixes:
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/GeoLabs/bblocks-stac/undefined/build/annotated/contrib/stac/extensions/accuracy/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/GeoLabs/bblocks-stac/undefined/build/annotated/contrib/stac/extensions/accuracy/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/GeoLabs/bblocks-stac/undefined/build/annotated/contrib/stac/extensions/accuracy/context.jsonld)
